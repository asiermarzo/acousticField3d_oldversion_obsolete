...
public class PlayerThread extends Thread{
    ...
    public void applyFrame(int frame) {
        ...
        if (form.mf.beadsToAnimationForm.isBeadsEnabled()){
            form.mf.beadsToAnimationForm.adjustBeads(frame, Entity.TAG_BEAD);
            form.mf.beadsToAnimationForm.adjustSlicesAndCubes(frame, Entity.TAG_BEAD);
        }
    }
    ...
    private void apply(final boolean isStepAnim, Animation anim) {
        ...
        synchronized(form.mf){
            ...
            form.mf.transControlPanel.sendData();
        }
        form.mf.needUpdate();
    }
    ...
    public void run() {
        while(!interrupted()){
            if (form.isPlaying()){
                ...
                form.mf.physicsPanel.tickIfEnabledForAnimation();
