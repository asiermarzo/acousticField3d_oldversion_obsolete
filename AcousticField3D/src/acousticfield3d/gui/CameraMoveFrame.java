...
public class CameraMoveFrame extends javax.swing.JFrame {
    ...
    private void doButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doButtonActionPerformed
        ...
        final float rotation = Parse.stringToFloat( rotText.getText() );
        final float delay = Parse.stringToFloat( delayText.getText() );
        ...
        Thread task = new Thread( new Runnable() {
            ...
            public void run() {
                ...
                for(int i = 0; i < steps; ++i){
                    mf.scene.getCamera().moveAzimuthAndInclination( incRot * FastMath.DEG_TO_RAD, 0.0f);
