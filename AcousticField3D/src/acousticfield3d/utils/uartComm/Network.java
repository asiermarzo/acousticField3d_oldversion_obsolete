 ...
 * has since been modified to suit UltraHaptics. Mainly style and documentation
 * modifications.
 */
/**
 * @todo Update formatting and comments to match the rest of the package.
 */
 ...
 * {@link net.NetworkIface}-interface.
 *
...
public class Network {
    ...
    /**
     * Link to the instance of the class implementing {@link net.NetworkIface}.
     */
     ...
     * in the constructor).
     *
     * @see net.Network#Network(int, NetworkIface, int)
     */
    private int divider;
    /**
     ...
     */
    public Network(int id, NetworkInterface contact, int divider) {
     ...
     * {@link net.NetworkIface#writeLog(int, String)}.
     *
     ...
     */
    public boolean writeSerial(final int numBytes,final int message[], final int offset) {
        boolean success = true;
        final int endPos = numBytes+offset;
